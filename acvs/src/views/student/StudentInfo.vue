...
onMounted(() => {
    console.log('用户信息存储:', userInfoStore.info);
    console.log('用户名:', userInfoStore.info.username);
    console.log('创建时间:', userInfoStore.info.createTime);
    ...
    //有realName字段则截取 第一个&之前的内容作为学生姓名 第二个为院校名称
...
// 提供更新基本信息服务
import { updateStudentInfoService } from '@/api/student.js'
const update = async () => {
    ...
    let result = await updateStudentInfoService(updateInfo.value)
    if (result.code === 0) {
...
<template>
    <div class="college-info-container">
        <div class="page-header">
            ...
            <p class="description">请完善您的学生信息</p>
        </div>
            ...
            <el-card class="info-card">
                <el-form class="info-form" label-width="120px" :model="formData">
                    ...
                    <el-form-item label="毕业院校">
                        <el-input v-model="formData.collegeName" placeholder="请输入毕业院校" />
                    </el-form-item>
                    <el-form-item label="学生姓名">
                        <el-input v-model="formData.adminName" placeholder="请输入学生姓名" />
                    </el-form-item>
                    <el-form-item label="身份证号">
                        <el-input v-model="formData.idCard" placeholder="学生身份证号已隐藏" />
                    </el-form-item>
                    ...
                    <el-form-item>
                        ...
                        <el-button type="primary" size="large" @click="console.log('修改密码')">修改密码</el-button>
                    </el-form-item>
                </el-form>
            </el-card>
        </div>
