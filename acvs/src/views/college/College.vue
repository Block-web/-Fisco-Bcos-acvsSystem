      ...
      <el-aside width="200px" class="sidebar">
        <el-menu :default-openeds="['1', '3']" class="full-height-menu" router :default-active="$route.path">
          ...
          <el-sub-menu index="2">
            ...
            <el-menu-item-group>
             <el-menu-item index="/college/verify-certificate-college">生成Hash</el-menu-item>
              <el-menu-item index="/college/chain-upload">确认信息并上传</el-menu-item>
              <el-menu-item index="/college/revoke-Certificate">撤销证书</el-menu-item>
            </el-menu-item-group>
          </el-sub-menu>
          <el-sub-menu index="3">
            <template #title>
            ...
            <el-menu-item-group>
              <el-menu-item index="/college/info">基本信息</el-menu-item>
              <el-menu-item index="/college/college-update-password">修改密码</el-menu-item>
